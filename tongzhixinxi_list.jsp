...
if(request.getParameter("biaoti")=="" ||request.getParameter("biaoti")==null ){}else{sql=sql+" and biaoti like '%"+request.getParameter("biaoti")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="tongzhixinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="tongzhixinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="tongzhixinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
