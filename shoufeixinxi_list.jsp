...
if (request.getParameter("shoufeiriqi2")==""  ||request.getParameter("shoufeiriqi2")==null ) {}else {sql=sql+" and shoufeiriqi <= '"+request.getParameter("shoufeiriqi2")+"'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="shoufeixinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="shoufeixinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="shoufeixinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
